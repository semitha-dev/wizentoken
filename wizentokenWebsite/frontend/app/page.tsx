...
export function useFixedCountdown() {
  ...
  useEffect(() => {
    ...
    const target = new Date("2025-05-20T12:00:00Z");
 ...
 const faqs = [
  {
    question: 'Question 1?',
    answer:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id dui nec ante commodo vestibulum id non nulla. Integer eu pellentesque orci, sit amet pharetra dolor.',
  },
